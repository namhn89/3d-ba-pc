...
import data_utils
import logging
from models.randla_net import RandLANet, get_loss
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='randla_cls', help='use model for training')
...
if __name__ == '__main__':
    ...
    classifier = RandLANet(d_in=3, num_classes=40, num_neighbors=16, decimation=4, device=device)
